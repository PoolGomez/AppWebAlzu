...
// type Props ={
//     canvas: Canvas;
//     obj : React.MouseEvent<HTMLButtonElement>;
//     setGuideLines: React.Dispatch<React.SetStateAction<[]>>;
// }

export const handleObjectMoving = (canvas, obj, guidelines, setGuidelines) => {
// export const handleObjectMoving  = (
//     {canvas, obj, setGuideLines}:{
//         canvas:Canvas,
//         obj : ChangeEvent,
//         setGuideLines: Dispatch<SetStateAction<[]>>,
//     }
// ) => {
    // const{canvas,obj,setGuideLines} = props;
